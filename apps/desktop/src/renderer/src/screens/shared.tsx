...
export const problemMessage = (error: unknown): string => {
  if (error instanceof ApiProblemError) {
    const labels: Record<string, string> = {
      ...
      EXCHANGE_RATE_REQUIRED: 'Ese pago está en otra moneda y necesita la tasa del día: regístrala en Tasas.',
      EXCHANGE_RATE_NOT_FOUND: 'La tasa con que se capturó el pago ya no existe: quita el pago y agrégalo de nuevo.',
      CURRENCY_RATE_EXPIRED: 'La tasa con que se capturó el pago ya no rige: quita el pago y agrégalo de nuevo.',
      CURRENCY_UNSUPPORTED: 'Esa moneda no está habilitada en este sistema.',

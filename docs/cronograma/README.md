...
| 12 | [Optimización](./fase-12-optimizacion/README.md) | En ejecución: 12.01 y 12.02 cerradas el 2026-09-16 —línea base y márgenes la primera, sin cambios productivos la segunda—; 12.03 en curso desde el 2026-09-16 con caracterización cerrada y tres cortes medidos —catálogo, kardex y reconstrucción del inventario, este último decidido en ADR-0032—; falta su serie limpia; después 12.05; 12.04 suspendida con Fase 8 |

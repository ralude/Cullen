...
| 12 | [Optimización](./fase-12-optimizacion/README.md) | En ejecución: 12.01 y 12.02 cerradas el 2026-09-16 —línea base y márgenes la primera, sin cambios productivos la segunda—; 12.03 en curso desde el 2026-09-16 —instrumento de conteo y plan, corte de catálogo y caracterización cerrada el 2026-09-17— y detenida en su gate de modelo: rehidratar inventario con historia profunda no es un problema de SQLite; después 12.05; 12.04 suspendida con Fase 8 |

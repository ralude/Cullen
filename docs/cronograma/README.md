...
| 12 | [Optimización](./fase-12-optimizacion/README.md) | En ejecución: 12.01 y 12.02 cerradas el 2026-09-16 —línea base y márgenes la primera, sin cambios productivos la segunda—; 12.03 cerrada el 2026-09-17 con cuatro cortes medidos y su campaña A/B —catálogo ×25, kardex ×1.110 y rehidratación de inventario ×91, esta última decidida en ADR-0032; el guardado cerró sin cambio productivo—; 12.05 en ejecución desde el 2026-09-17 con cinco cortes entregados y su benchmark publicado —los seis escenarios abren entre 13,7 % y 32,8 % menos superficie sin ganar saltos—; le falta sólo registrar sesiones reales de navegación, que exigen un contexto nuevo; 12.04 suspendida con Fase 8 |

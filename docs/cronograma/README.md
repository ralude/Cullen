...
| 12B | [Manual de usuario no técnico](./fase-12b-manual-usuario/README.md) | **En ejecución** desde el 2026-09-18: 12B.01 y 12B.02 entregadas, el texto de 12B.04–12B.09 escrito y la absorción de 12B.10 hecha. 12B.03 va 2 de 15 capturas. Planificada el 2026-09-09 después de `v0.1.0`; fase documental, no bloquea ni depende de Fase 12 |
...
[12B.03](./fase-12b-manual-usuario/12b.03-capturas.md) —dos de quince capturas, bloqueada por una
sesión interactiva— y la prueba con lector real de 12B.10. La

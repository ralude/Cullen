...
| 12B | [Manual de usuario no técnico](./fase-12b-manual-usuario/README.md) | **En ejecución** desde el 2026-09-18: 12B.01 y 12B.02 entregadas. Planificada el 2026-09-09 después de `v0.1.0`; fase documental, no bloquea ni depende de Fase 12 |
...
cerrar la Fase 12 y en ejecución desde ese mismo día, con
[12B.01](./fase-12b-manual-usuario/12b.01-inventario-de-interfaz.md) y
[12B.02](./fase-12b-manual-usuario/12b.02-lenguaje-y-plantilla.md) entregadas: el inventario de
las quince pantallas sobre `bcc6f8f` y la plantilla, el registro y el glosario del manual. La
